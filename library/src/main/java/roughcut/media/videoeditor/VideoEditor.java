...
public interface VideoEditor {
     ...
     *           int callbackAfterFrameCount, roughcut.media.videoeditor.VideoEditor.PreviewProgressListener listener)}
     */
     ...
     *                roughcut.media.videoeditor.VideoEditor.ExportProgressListener listener)}
     */
     ...
     *
     * @throws java.io.IOException if the internal state cannot be saved to project file
     */
     ...
     * @throws java.io.IOException if output file cannot be created
     ...
     * {@link roughcut.media.videoeditor.Transition#generate()} method must be invoked to generate
